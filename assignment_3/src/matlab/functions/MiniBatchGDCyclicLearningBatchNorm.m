function [Wstar, bstar, gamma_star, beta_star, nt_hist,NetParams] = MiniBatchGDCyclicLearningBatchNorm(X, Y, GDparams, W, B, lambda, nt_hist, n_s, nmin, nmax,alpha,NetParams)
    ...
    for j=1:size(X,2)/GDparams.n_batch
        ...
        % Forward pass
        [S,S_hat,P,H,mew,v] = ComputeNetworkBatchNorm(Xbatch,W,B,NetParams);
